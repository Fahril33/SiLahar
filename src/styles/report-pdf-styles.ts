...
.pdf-report-main-table thead {
  display: table-header-group;
}

.pdf-report-main-table tbody {
...
/* Ensure rightmost outer border is solid and immune to browser subpixel margin clipping */
.pdf-report-main-table th:last-child,
.pdf-report-main-table td:last-child,
.pdf-report-main-table th.col-proof,
.pdf-report-main-table th.col-consolidated-proof,
.pdf-report-main-table td.proof-cell {
...
/* Consolidated / Weekly Report Columns */
.pdf-report-main-table .col-consolidated-no {
  width: 6%;
}

.pdf-report-main-table .col-consolidated-date {
  width: 18%;
}

.pdf-report-main-table .col-consolidated-detail {
  width: 40%;
}

.pdf-report-main-table .col-consolidated-time {
  width: 16%;
}

.pdf-report-main-table .col-consolidated-proof {
  width: 20%;
}
...
.pdf-report-main-table .date-cell {
  text-align: center;
  vertical-align: middle;
  font-size: 10pt;
